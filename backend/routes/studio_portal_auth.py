...
async def request_access(data: RequestAccessInput, request: Request):
    ...
    try:
        ...
        verification_url = f"{os.environ.get('FRONTEND_URL', 'https://studio-stage.preview.emergentagent.com')}/verify-access?token={verification_token}"
...
async def forgot_password(data: ForgotPasswordInput):
    ...
    try:
        ...
        reset_url = f"{os.environ.get('FRONTEND_URL', 'https://studio-stage.preview.emergentagent.com')}/reset-password?token={reset_token}"
