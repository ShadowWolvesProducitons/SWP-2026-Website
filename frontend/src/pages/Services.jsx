    ...
    <div className="services-page pt-20">
      ...
      <section className="page-header py-24 bg-gradient-to-br from-black via-smoke-gray to-black relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <h1 className="text-6xl md:text-7xl font-bold text-white mb-6 font-cinzel">Our Services</h1>
                ...
                {idx % 2 === 0 ? (
                  <>
                    ...
                    <div>
                      ...
                      <h2 className="text-5xl font-bold text-white mb-3 font-cinzel">{service.name}</h2>
      ...
      <section className="cta-section py-24 bg-smoke-gray">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-5xl md:text-6xl font-bold text-white mb-6 font-cinzel">
            Ready to Start
            <br />
